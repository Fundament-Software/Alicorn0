...
local core_operations = {
	...
	["prim-number"] = lit_term(value.prim_number_type, unrestricted(value.prim_type_type)),
	["prim-type"] = lit_term(value.prim_type_type, unrestricted(value.star(1))),
	["prim-func-type"] = exprs.primitive_operative(prim_func_type_impl, "prim_func_type_impl"),
	type = lit_term(value.star(0), unrestricted(value.star(1))),
