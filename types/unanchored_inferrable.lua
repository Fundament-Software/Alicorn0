...
---@field record_elim fun(subject: anchored_inferrable, field_names: ArrayValue<string>, debug_ids: ArrayValue<spanned_name>, body: anchored_inferrable): unanchored_inferrable
