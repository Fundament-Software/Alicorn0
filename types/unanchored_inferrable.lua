...
---@field bound_variable fun(index: number, debug: any): unanchored_inferrable
...
---@field enum_desc_cons fun(variants: MapValue, rest: anchored_inferrable): unanchored_inferrable
...
---@field enum_case fun(target: anchored_inferrable, variants: MapValue): unanchored_inferrable
...
---@field program_sequence fun(first: anchored_inferrable, start_anchor: Anchor, continue: anchored_inferrable): unanchored_inferrable
