...
local function make_tuple_prefix(subject_type, subject_value)
	...
	if subject_type:is_tuple_type() then
		...
		elseif subject_value:is_neutral() then
			...
			error("infer, make_tuple_prefix, is_tuple_elim, is_tuple_type, subject_value: expected a tuple")
		end
	elseif subject_type:is_prim_tuple_type() then
		...
		elseif subject_value:is_neutral() then
			...
			error(
				"infer, make_tuple_prefix, is_tuple_elim, is_prim_tuple_type, subject_value: expected a primitive tuple"
			)
		end
	else
		error("infer, make_tuple_prefix, is_tuple_elim, subject_type: expected a term with a tuple type")
	end
