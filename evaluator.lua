...
function gather_usages(val, usages, context_len, ambient_typechecking_context, gas)
	...
	if gas == nil then
		gas = U.GasTank(50000, function(self)
	...
	elseif val:is_host_int_fold() then
		...
		gather_usages(flex_value.stuck(num), usages, context_len, ambient_typechecking_context, gas:decrement())
		gather_usages(fun, usages, context_len, ambient_typechecking_context, gas:decrement())
		gather_usages(acc, usages, context_len, ambient_typechecking_context, gas:decrement())
